...
public class WordCount extends Configured implements Tool
{
        ...
        throws Exception
    {
        ...
        for (int i = 0; i < WordCountSetup.TEST_COUNT; i++)
        {
            ...
            SlicePredicate predicate = new SlicePredicate().setColumn_names(Arrays.asList(ByteBufferUtil
                    .bytes(columnName)));
            ConfigHelper.setInputSlicePredicate(job.getConfiguration(), predicate);

            if (i == 4)
            {
                IndexExpression expr = new IndexExpression(ByteBufferUtil.bytes("int4"), IndexOperator.EQ,
            ...
            ConfigHelper.setOutputInitialAddress(job.getConfiguration(), "16.158.83.35");
